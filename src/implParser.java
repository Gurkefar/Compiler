...
public class implParser extends Parser {
	...
	public static final int
		...
		T__17=18, T__18=19, T__19=20, T__20=21, T__21=22, T__22=23, IDARR=24, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			"IDARR", "ID", "FLOAT", "ALPHA", "NUM", "WHITESPACE", "COMMENT", "COMMENT2"
		};
	}
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4) | (1L << T__5) | (1L << T__8) | (1L << T__10) | (1L << IDARR) | (1L << ID))) != 0)) {
				{
				{
				setState(10);
	...
	public static class IfElseContext extends CommandContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof implListener ) ((implListener)listener).enterIfElse(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof implListener ) ((implListener)listener).exitIfElse(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof implVisitor ) return ((implVisitor<? extends T>)visitor).visitIfElse(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ArrAssignmentContext extends CommandContext {
		public Token x;
		public ExprContext e;
		public TerminalNode IDARR() { return getToken(implParser.IDARR, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public ArrAssignmentContext(CommandContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof implListener ) ((implListener)listener).enterArrAssignment(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof implListener ) ((implListener)listener).exitArrAssignment(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof implVisitor ) return ((implVisitor<? extends T>)visitor).visitArrAssignment(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final CommandContext command() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				setState(34);
				((ArrAssignmentContext)_localctx).x = match(IDARR);
				setState(35);
				match(T__2);
				setState(36);
				((ArrAssignmentContext)_localctx).e = expr(0);
				setState(37);
				match(T__3);
				}
				break;
			...
			case 5:
				...
				match(T__6);
				setState(51);
				((ForLoopContext)_localctx).index = match(ID);
				setState(52);
				match(T__2);
				setState(53);
			...
			case 7:
				...
				match(T__7);
				setState(69);
				((IfElseContext)_localctx).p1 = program();
				setState(70);
				match(T__11);
				setState(71);
				((IfElseContext)_localctx).p2 = program();
				}
				break;
			}
		}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case IDARR:
				...
				_prevctx = _localctx;
				setState(78);
				((ArrayContext)_localctx).x = match(IDARR);
				}
				break;
			case T__6:
				{
	...
	private ConditionContext condition(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				match(T__18);
				setState(106);
				((NotContext)_localctx).c = condition(5);
				}
				break;
			case 4:
				{
	...
	public static final String _serializedATN =
		...
		"\b\n\2\4\3\2\17\20\3\2\21\22\2\u0091\2\17\3\2\2\2\4\35\3\2\2\2\6K\3\2"+
		"\2\2\bU\3\2\2\2\nu\3\2\2\2\f\16\5\6\4\2\r\f\3\2\2\2\16\21\3\2\2\2\17\r"+
		...
		"\7\4\2\2\35\24\3\2\2\2\35\25\3\2\2\2\36\5\3\2\2\2\37 \7\33\2\2 !\7\5\2"+
		"\2!\"\5\b\5\2\"#\7\6\2\2#L\3\2\2\2$%\7\32\2\2%&\7\5\2\2&\'\5\b\5\2\'("+
		"\7\6\2\2(L\3\2\2\2)*\7\7\2\2*+\5\b\5\2+,\7\6\2\2,L\3\2\2\2-.\7\b\2\2."+
		"/\7\t\2\2/\60\5\n\6\2\60\61\7\n\2\2\61\62\5\4\3\2\62L\3\2\2\2\63\64\7"+
		"\13\2\2\64\65\7\t\2\2\65\66\7\33\2\2\66\67\7\5\2\2\678\5\b\5\289\7\f\2"+
		"\29:\5\b\5\2:;\7\n\2\2;<\5\4\3\2<L\3\2\2\2=>\7\r\2\2>?\7\t\2\2?@\5\n\6"+
		"\2@A\7\n\2\2AB\5\4\3\2BL\3\2\2\2CD\7\r\2\2DE\7\t\2\2EF\5\n\6\2FG\7\n\2"+
		"\2GH\5\4\3\2HI\7\16\2\2IJ\5\4\3\2JL\3\2\2\2K\37\3\2\2\2K$\3\2\2\2K)\3"+
		"\2\2\2K-\3\2\2\2K\63\3\2\2\2K=\3\2\2\2KC\3\2\2\2L\7\3\2\2\2MN\b\5\1\2"+
		"NV\7\34\2\2OV\7\33\2\2PV\7\32\2\2QR\7\t\2\2RS\5\b\5\2ST\7\n\2\2TV\3\2"+
		"\2\2UM\3\2\2\2UO\3\2\2\2UP\3\2\2\2UQ\3\2\2\2V_\3\2\2\2WX\f\b\2\2XY\t\2"+
		"\2\2Y^\5\b\5\tZ[\f\7\2\2[\\\t\3\2\2\\^\5\b\5\b]W\3\2\2\2]Z\3\2\2\2^a\3"+
		"\2\2\2_]\3\2\2\2_`\3\2\2\2`\t\3\2\2\2a_\3\2\2\2bc\b\6\1\2cd\5\b\5\2de"+
		"\7\23\2\2ef\5\b\5\2fv\3\2\2\2gh\5\b\5\2hi\7\24\2\2ij\5\b\5\2jv\3\2\2\2"+
		"kl\7\25\2\2lv\5\n\6\7mn\5\b\5\2no\7\30\2\2op\5\b\5\2pv\3\2\2\2qr\5\b\5"+
		"\2rs\7\31\2\2st\5\b\5\2tv\3\2\2\2ub\3\2\2\2ug\3\2\2\2uk\3\2\2\2um\3\2"+
		"\2\2uq\3\2\2\2v\177\3\2\2\2wx\f\6\2\2xy\7\26\2\2y~\5\n\6\7z{\f\5\2\2{"+
		"|\7\27\2\2|~\5\n\6\6}w\3\2\2\2}z\3\2\2\2~\u0081\3\2\2\2\177}\3\2\2\2\177"+
		"\u0080\3\2\2\2\u0080\13\3\2\2\2\u0081\177\3\2\2\2\f\17\31\35KU]_u}\177";
